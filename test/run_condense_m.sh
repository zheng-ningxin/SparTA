...
nvcc -ccbin g++ -I../../common/inc -m64  -maxrregcount=255 -gencode arch=compute_75,code=sm_75 -O3  -o _m_condense.o -c block_sparse_nt_condense_m.cu
nvcc -ccbin g++ -m64  -gencode arch=compute_75,code=sm_75 -O3  -o _m_condense  _m_condense.o

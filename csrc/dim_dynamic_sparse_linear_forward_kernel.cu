...
// __global__ void BLOCK_SPARSE_MATMUL_NN_OPENAI(float* A, float* B, float*output, int * B_k_index, int GLOBAL_M, int GLOBAL_K, int GLOBAL_N)
// {
//     /*
//     description:
//     tiling k dimension
...
//         // }
//             if (tid<BLOCK_SIZE_K){
//                 k_dim_index[tid] = B_k_index[tid + 64 * k_seq];
//             }
//             __syncthreads();
//             uint offsetA00 = ori_offsetA00 + 64 * k_seq;
//             uint offsetA16 = ori_offsetA16 + 64 * k_seq;
//             // uint offsetB00 = ori_offsetB00 + 64 * k_seq;
//             // uint offsetB16 = ori_offsetB16 + 64 * k_seq;
//             // printf("tid:%d bx:%d by%d ori_B_k_offset:%d ori_offsetB00:%d\n", tid, bx, by, ori_B_k_offset, ori_offsetB00);
//             uint offsetB00 = ori_offsetB00 + k_dim_index[ori_B_k_offset] * N;
//             uint offsetB16 = ori_offsetB00 + k_dim_index[ori_B_k_offset + 16] * N;

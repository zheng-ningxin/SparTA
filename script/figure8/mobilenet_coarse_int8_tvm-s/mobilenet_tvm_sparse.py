...
parser.add_argument('--model_path', type=str, default='/Data/nizhen/SparTA/script/checkpoints/mobilenet/artifact_mobilenet_coarsegrained_no_propagation_onnx_with_tesa/model_no_tesa.onnx', help='The file name of the frozen graph.')

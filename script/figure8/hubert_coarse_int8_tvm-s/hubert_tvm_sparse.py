...
parser.add_argument('--model_path', type=str, default='/Data/nizhen/SparTA/script/checkpoints/hubert/artifact_hubert_coarse_no_propagation_onnx_with_tesa/model_no_tesa.onnx', help='The file name of the frozen graph.')

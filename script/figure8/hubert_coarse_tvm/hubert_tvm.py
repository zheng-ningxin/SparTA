...
parser.add_argument('--model_path', type=str, default='/Data/nizhen/SparTA/script/checkpoints/hubert/artifact_hubert_ori/hubert_ori_no_tesa.onnx', help='The file name of the frozen graph.')
